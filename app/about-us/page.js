...
const studioColumns = [
  {
    ...
    body: [
      ...
      "Since our photo studio specializes in children, we also have various kinds of themes ready to shoot at the Sydney studio at any time, or in any type of weather. You don't need to bring anything but your loved one(s). We have 15 different themes for you to choose from. You may choose a photo shoot with a basic coloured paper background, or one of our other themes.",
      "It's not even necessary to head outdoors in inclement weather, but we can certainly make it look like your child is soaking up the rays of the sun in your favourite outdoor scene. You have your choice of a natural-feeling scene, outdoor garden scene, etc., with more themes coming. Our baby expert photographers in Sydney will work together to catch your loved one's different facial expressions.",
    ],
  },
  {
    title: "A variety of costumes and props are ready",
    body: [
      "Don't worry about how to dress your child or what to bring if you book a shooting at LookyLooky Photo Studio in Sydney.",
      ...
      "We also continue to upgrade our costumes and props for our trend-conscious customers. We know you'll be pleased with our selection, but we can also assist in choosing the right costumes for the right theme if you ever feel overwhelmed by the choices.",
      "And remember that you can always book another date for a future photoshoot if you see any fun costumes, props, or themes that you want to try with your child.",
    ],
  },
];
    ...
    <>
      ...
      <section className="container section-gap about-story">
        <div className="content-card prose-block center-copy about-intro-card">
          ...
          <p>
            Imagine in the years ahead how you can look back and ponder on these fun and delightful memories. Your baby or child will only be that age once, so it&apos;s important to capture every stage of life. Share your memories with your friends, family, and colleagues.
          </p>
          <p>
            Photographs make the best gift, and can be framed or made into posters, and more. When you&apos;re older, you&apos;ll cherish your photographs and family memories, rather than clutter you&apos;ve accumulated over the years.
          </p>
        </div>
